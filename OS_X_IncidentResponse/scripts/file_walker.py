...
class FileWalker(object):
    ...
    def collect(self, fileName, fi_id, time_fd):
        try:
    ...
    def run(self):
        ...
        with open(self.fileInfo, 'w+a') as fi_id, open(self.fileTimeline, 'w+a') as time_fd:
            for dirname, dirnames, filenames in os.walk(self.startDir, topdown=True):
                ...
                for filename in filenames:
                    ...
                    self.collect(fileWithPath, fi_id, time_fd)
