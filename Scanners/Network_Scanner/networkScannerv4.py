# Goal: detect if "alive" host is a printer, a computer,
#       a phone or any other type of device
#
# Description: utilize the ping3 and socket modules
# to perform a reverse DNS lookup on the hostname
# associated with the IP address using
...
def scan(host):
    ...
    if response_time:
        ...
        try:
            ...
            print(f"Type of device: {hostname}")
